...
while True:
    ...
    if answer(ans) == False: print('\nОтвет должен быть "ДА" или "НЕТ"! \n')
        ...
        if ans.lower() == 'нет':
            ...
            print("                                                                     ПРАВИЛА ИГРЫ")
            print('\nВ корзине лежат 2021 конфета! Ты и твой противник поочереди брут конфеты из корзины. Взять можно от 1 до 28 конфет. Ход пропускать нельзя! Кто ходит первый, определяет случай!\n')
